...
best_T=25
best_L=0.01
test_thetas = p1.pegasos(train_bow_features, train_labels, best_T, best_L)
test_preds = p1.classify(test_bow_features, test_thetas[0], test_thetas[1])
...
best_theta = test_thetas[0] # Your code here
